      ...
      case "primaryLight":
        return ThemeData(
          ...
          MaterialColor(4293223245, {
            ...
            300: Color(0xFF062C56),
            400: Color(0xff062C56),
            500: Color(0xff062C56),
            600: Color(0xFF062C56),
            700: Color(0xFF062C56),
            800: Color(0xFF062C56),
            900: Color(0xFF062C56)
          }),

          fontFamily: font,
          brightness: Brightness.light,
          // primaryColor: Color(0xff03502B),
          primaryColor: Color(0xff062C56), //updated on 14/06/2021 for screen updation colors
          primaryColorBrightness: Brightness.dark,
          primaryColorLight: Color(0xff062C56),
          // darkorangeColor: Color(0xffEF7422),
          // darkgreenColor: Color(0xff509D45),
          // darkblueColor: Color(0xff254EA1),
          primaryColorDark: Color(0xff062C56),
          //imp
          colorScheme: ColorScheme.fromSwatch(primarySwatch:Colors.blue,
              accentColor:Color(0xff062C56),brightness: Brightness.light ),
          ...
          buttonColor: Color(0xffE4001B),
         // defaultbuttonColor: Color(0xff00008C),
